...
HD_PWD='C:/devWorks/AudioProcessing/SoC_PynzZ2_AUDIO/SoC_PynzZ2_AUDIO.runs/design_1_audio_codec_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_audio_codec_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_audio_codec_ctrl_0_0.tcl
